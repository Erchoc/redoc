  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <RedocAttribution>
          {!options.sideMenuLogo ? (
            <a target="_blank" rel="noopener noreferrer" href={'https://redocly.com/redoc/'}>
              <RedoclyLogo />
              API docs by Redocly
            </a>
          ) : (
            <a target="_blank" rel="noopener noreferrer" href={options.sideMenuLogo?.href}>
              <img src={options.sideMenuLogo?.imgUrl} alt={options.sideMenuLogo?.docs} />
              {options.sideMenuLogo?.docs}
            </a>
          )}
        </RedocAttribution>
      </PerfectScrollbarWrap>
